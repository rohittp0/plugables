...
This project is indexed by GitNexus as **plugables** (319 symbols, 700 relationships, 16 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
