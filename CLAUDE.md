...
This project is indexed by GitNexus as **plugables** (1391 symbols, 3080 relationships, 55 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
