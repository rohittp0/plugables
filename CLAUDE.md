...
This project is indexed by GitNexus as **plugables** (349 symbols, 732 relationships, 16 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
